...
cdi = Subject('Cálculo Diferencial e Integral', [], ['Sexta, 13:30 - 17:00'], 1)
    ...
    #Segundo periodo
estdd = Subject("Estrutura de Dados", [p1], ['Segunda, 13:00 - 15:10', 'Quarta, 13:00 - 15:20'], 2)
...
pe = Subject('Probabilidade e estatistica', [cdi], ['Terça, 13:30 - 15:10', 'Quinta, 13:30 - 15:10'], 3)
al = Subject('Álgebra Linear', [ga], ['Terça, 15:20 - 17:00', 'Quinta, 15:20 - 17:00'], 3)

    #Quarto periodo
p2 = Subject("Programação 2", [estdd, bd, redes], ['Segunda, 13:00 - 15:10', 'Quarta, 13:00 - 15:20'], 4)
p3 = Subject("Programação 3", [estdd, bd, redes], ['Segunda, 15:20 - 17:00', 'Quarta, 15:20 - 17:00'], 4)
paa = Subject("Projeto e Análise de Algoritmos", [estdd, grafos], ['Terça, 13:00 - 15:10', 'Quinta, 13:00 - 15:10'], 4)
tc = Subject("Teoria da Computação", [], ['Terça - 15:20 - 17:00', 'Quinta, 15:20 - 17:00'], 4)

    #Quinto Periodo
sistemas = Subject('Sistemas Operacionais', [oac], ['Segunda, 13:30 - 15:10', 'Quarta, 13:30 - 15:10'], 5)
compiladores = Subject('compiladores', [estdd, tc], ['Segunda, 15:20 - 17:00', 'Quarta, 15:20 - 17:00'], 5)
ia = Subject('Inteligência Artificial', [logica, estdd], ['Terça, 13:30 - 15:10', 'Quinta, 13:30 - 15:10'], 5)
cg = Subject('Computação Gráfica', [], ['Terça, 15:20 - 17:00', 'Quinta, 15:20 - 17:00'], 5)

    #Sexto periodo = Projeto
pds = Subject('Projeto e Desenvolvimento de Sistemas', [subject for subject in disciplinas if subject.getInfo()['availableAt'] <= 5], ['Segunda 13:00 - 17:00', 'Quarta, 13:00 - 17:00'], 6)
...
#Eletivas
c3 = Subject('Cálculo 3', [cdi], ['Terça, 13:30 - 15:10', 'Quinta, 13:30 - 15:10'], 2)
clp = Subject('Conceitos de Linguagem de Programação', [], ['Segunda, 07:30 - 09:10', 'Quarta, 07:30 - 09:10'], None)
am = Subject('Aprendizagem de Máquina', [c3], ['Segunda, 09:20 - 12:10', 'Quarta, 09:20 - 12:10'], None)
...
ihm = Subject('Interação Homem-Máquina', [p3], ['Sexta, 07:30 - 11:30'], None)
pdi = Subject('Processamento Digital de Imagens', [cg], ['Terça, 13:30 - 15:10', 'Quinta, 13:30 - 15:10'], 6)
...
gep = Subject('Gerência de Projeto', [pds], ['Segunda, 13:30 - 15:10', 'Quarta, 13:30 - 15:10'], 7)
vc = Subject('Visão Computacional', [], ['Terça, 15:20 - 17:10', 'Quinta, 15:20 - 17:10'], 2)
cd = Subject('Ciência de Dados', [pe], ['Segunda, 07:30 - 09:10', 'Quarta, 07:30 - 09:10'], 4)
micap = Subject('Microcontroladores e Aplicações', [], ['Segunda, 15:20 - 17:00', 'Quarta, 15:20 - 17:00'], None)
ssc = Subject('Segurança de Sistemas Computacionais', [redes], ['Segunda, 13:30 - 15:10', 'Quarta, 13:30 - 15:10'], None)
